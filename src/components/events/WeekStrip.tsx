      ...
      {days.map(day => {
        ...
        return (
          <TouchableOpacity
            ...
            activeOpacity={0.8}>
            <Text style={[styles.letter, selected && styles.selectedText]}>{format(day, 'EEEEE')}</Text>
            <Text style={[styles.number, selected && styles.selectedText]}>{format(day, 'd')}</Text>
...
const styles = StyleSheet.create({
  ...
  selectedDay: {backgroundColor: colors.gold.default, borderColor: colors.gold.default},
